...
namespace HealthHorizon_API.Migrations
{
    ...
    partial class HealthHorizonContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthHorizon_API.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HealthHorizon_API.Models.TimeSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HealthHorizon_API.Models.Medical_Record_Types.AllergyTest", b =>
                {
                    ...
                    b.HasOne("HealthHorizon_API.Models.PersonTypes.MedicalRecord", "MedicalRecord")
            ...
            modelBuilder.Entity("HealthHorizon_API.Models.PersonTypes.AIChatLog", b =>
                {
                    b.HasOne("HealthHorizon_API.Models.PersonTypes.Patient", "Patient")
                        .WithOne()
                        .HasForeignKey("HealthHorizon_API.Models.PersonTypes.AIChatLog", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HealthHorizon_API.Models.PersonTypes.Appointment", b =>
                {
                    b.HasOne("HealthHorizon_API.Models.PersonTypes.Doctor", "Doctor")
                        .WithOne()
                        .HasForeignKey("HealthHorizon_API.Models.PersonTypes.Appointment", "DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HealthHorizon_API.Models.PersonTypes.Patient", "Patient")
                        .WithOne()
                        .HasForeignKey("HealthHorizon_API.Models.PersonTypes.Appointment", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HealthHorizon_API.Models.PersonTypes.Bill", b =>
                {
                    b.HasOne("HealthHorizon_API.Models.PersonTypes.Appointment", "Appointment")
                        .WithOne()
                        .HasForeignKey("HealthHorizon_API.Models.PersonTypes.Bill", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HealthHorizon_API.Models.PersonTypes.Patient", b =>
                {
                    b.HasOne("HealthHorizon_API.Models.Address", "Address")
                        .WithOne("Patient")
                        .HasForeignKey("HealthHorizon_API.Models.PersonTypes.Patient", "AddressId");
            ...
            modelBuilder.Entity("HealthHorizon_API.Models.PersonTypes.Prescription", b =>
                {
                    b.HasOne("HealthHorizon_API.Models.PersonTypes.Appointment", "Appointment")
                        .WithOne()
                        .HasForeignKey("HealthHorizon_API.Models.PersonTypes.Prescription", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HealthHorizon_API.Models.PersonTypes.Staff", b =>
                {
                    b.HasOne("HealthHorizon_API.Models.PersonTypes.StaffRole", "Role")
                        .WithOne()
                        .HasForeignKey("HealthHorizon_API.Models.PersonTypes.Staff", "RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HealthHorizon_API.Models.TimeSlot", b =>
                {
                    b.HasOne("HealthHorizon_API.Models.PersonTypes.Doctor", "Doctor")
                        .WithOne()
                        .HasForeignKey("HealthHorizon_API.Models.TimeSlot", "DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
